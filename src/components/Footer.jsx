            ...
            <div className="flex space-x-4">
              {churchInfo.social.facebook && (
                <a
                  ...
                  className="text-white/60 hover:text-white focus:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-black rounded transition-colors"
                  aria-label="Facebook"
                >
